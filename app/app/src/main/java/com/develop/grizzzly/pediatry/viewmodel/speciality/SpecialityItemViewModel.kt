...
class SpecialityItemViewModel constructor(private val model : RegistrationViewModel, private val activity : Activity, val speciality : Speciality, val type : Int) : ViewModel() {
