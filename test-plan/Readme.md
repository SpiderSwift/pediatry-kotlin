...
2. Заполнить все поля, иначе кнопка "Далее" будет серого цвета и нельзя будет перейти дальше: 
   ...
   - Телефон:
      * указывается по шаблону, начинается с +7 (...) ...
      *
      *
   - Город:
     * сделать проверку на существующий город? Большая\маленькая буква, наличие странных символов
     *
     *
3. С выбором фотогрфафии или без ничего не измениться   
