...
2. Необходимо заполнить все поля: 
   - ФИО - доступен ввод для 3 слов через пробел (необходимо протестировать на ввод символов)
   - Телефон - указывается с +7 (...) ... (необходимо добавить проверку на ввод цифр)
   - Город - необходимо протестировать на ввод символов
...
Результат: Просмотр конференции.
